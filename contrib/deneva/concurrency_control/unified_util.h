...
#include "../unified_concurrency_control/alg_dli_identify_merge.h"
...
template <> constexpr const ttts::UniAlgs uni_alg<DLI_IDENTIFY_2> = ttts::UniAlgs::UNI_DLI_IDENTIFY_MERGE;
